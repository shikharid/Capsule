...
angular.module('capsuleApp').controller('pendingController', ['Authentication', '$location', '$scope', 'Assignment',
function(Authentication, $location, $scope, Assignment){
        ...
        Authentication.isAuthenticated().then(
            function(data){
                if(!data.loggedIn) {
                    ...
                    Assignment.getStudentList().then(
                        function (data) {
                            console.log(data);
